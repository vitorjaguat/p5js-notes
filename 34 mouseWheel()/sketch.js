// mouseWheel() detecta un evento de rueda de raton vertical (y), ya sea generado por un raton o por un touchpad (detecta o scroll -> deslize no touchpad com 2 dedos).
// la propiedad event.delta da la distancia que el raton ha avanzado
